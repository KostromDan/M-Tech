let ac_tome_data = '{"akashictome:data":{' +
    ...
    'computercraft:{Count:1b,id:"computercraft:computer_craft_manual",tag:{"akashictome:displayName":{text:\'{"translate":"item.computercraft.computer_craft_manual"}\'},"akashictome:is_morphing":1b,display:{Name:\'{"translate":"akashictome.sudo_name","with":[{"color":"green","translate":"item.computercraft.computer_craft_manual"}]}\'}}},' +
    'create:{Count:1b,id:"create:create_manual",tag:{"akashictome:displayName":{text:\'{"translate":"item.create.create_manual"}\'},"akashictome:is_morphing":1b,display:{Name:\'{"translate":"akashictome.sudo_name","with":[{"color":"green","translate":"item.create.create_manual"}]}\'}}},' +
    ...
    'mekanism:{Count:1b,id:"mekanism:mekanism_guide",tag:{"akashictome:displayName":{text:\'{"translate":"item.mekanism.mekanism_guide"}\'},"akashictome:is_morphing":1b,display:{Name:\'{"translate":"akashictome.sudo_name","with":[{"color":"green","translate":"item.mekanism.mekanism_guide"}]}\'}}},' +
    'naturescompass:{Count:1b,id:"naturescompass:naturescompass",tag:{}},' +
    'simpleplanes:{Count:1b,id:"patchouli:guide_book",tag:{"patchouli:book":"simpleplanes:planes_book"}}},"akashictome:is_morphing":1b}'
...
let ac_tome_must_include = ['advancedperipherals:manual', "ae2:guide", "alexsmobs:animal_dictionary", "apotheosis:apoth_chronicle", "create:create_manual", "explorerscompass:explorerscompass", "ftbquests:book",
    "immersiveengineering:manual", "mekanism:mekanism_guide", "naturescompass:naturescompass", "simpleplanes:planes_book", "computercraft:computer_craft_manual"]
